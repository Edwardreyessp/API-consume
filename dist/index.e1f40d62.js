...
})({"1iL3g":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 3004;
...
const get = async () => {
  try {
    ...
    const result = data.map(personaje => generarTarjeta(personaje)).join(' ');
...
btnPost.addEventListener('click', event => {
  ...
  post(setPost);
  get();
  const setNameText = document.getElementById("nameText").value = '';
  const setDesText = document.getElementById("desText").value = '';
});
// PUT
...
btnPut.addEventListener('click', event => {
  ...
  put(setPut);
  get();
  const setIdText = document.getElementById("idText").value = '';
  const setNameText = document.getElementById("nameText").value = '';
  const setDesText = document.getElementById("desText").value = '';
});
// DELETE
...
},{}]},["1iL3g","5jkUb"], "5jkUb", "parcelRequirefeb0")
